...
<div class="container">
   ...
   <div class="row justify-content-center">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="row justify-content-center">API LINK : https://chatvago.tier5-development.us/insertUser?userid={{ Auth::user()->id }}&psid={{($pageScopeUserId == '') ? 'PSID' : $pageScopeUserId}}</h4>
